...
class Enemy():
    ...
    def draw(self):
        ...
        self.width = 30
        self.height = 30
        self.screen.blit(basic_enemy_image, (self.x - 12, self.y - 12))
...
class Kamikaze(Enemy):
    ...
    def draw(self):
        ...
        self.width = 30
        self.height = 30
        self.screen.blit(kamikaze_enemy_image, (self.x - 13, self.y - 13))
...
class Shooter(Enemy):
    ...
    def draw(self):
        ...
        self.width = 30
        self.height = 30
        self.screen.blit(pistol_enemy_image, (self.x - 12, self.y - 12))
...
class Elite(Shooter):
    ...
    def draw(self):
        ...
        self.width = 30
        self.height = 30
        self.screen.blit(elite_enemy_image, (self.x - 12, self.y - 12))
...
class Titan(Enemy):
    ...
    def draw(self):
        ...
        self.width = 30
        self.height = 30
        self.screen.blit(titan_enemy_image, (self.x - 12, self.y - 12))
